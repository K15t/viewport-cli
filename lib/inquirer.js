...
const { envTemplate } = require('./validate.js');
...
function askConfig({existingEnvNames = [], defaultConfig = {}}) {
    return inquirer.prompt([
        ...
        },
        {
            ...
            validate: value => envTemplate['confluenceBaseUrl'].test(value) || 'Enter a valid URL.'
        },
        {
            name: 'username',
            type: 'input',
        ...
        },
        {
            ...
            validate: value => envTemplate['targetPath'].test(value) || 'Enter a valid target path.'
        },
        {
            name: 'sourcePath',
            type: 'input',
            ...
            validate: value => envTemplate['sourcePath'].test(value) || 'Enter a valid source path.'
        }
    ]);
}
