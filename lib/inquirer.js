...
function askConfig({existingEnvNames = [], defaultConfig = {}, envTemplate}) {
    return inquirer.prompt([
        ...
        },
        {
            ...
            validate: value => envTemplate['targetPath'].test(value) || 'Enter a valid target path. It should contain a trailing slash.'
        },
        {
            name: 'sourcePath',
            type: 'input',
            ...
            validate: value => envTemplate['sourcePath'].test(value) || 'Enter a valid source path. It should contain a trailing slash.'
        }
    ]);
}
